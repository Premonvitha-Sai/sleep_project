...
def home_page():
    ...
    """)
    main_page_image = mpimg.imread('main_page_image.gif')
...
def result_page():
    ...
    if 45 < issue_prob < 50:
        ...
        st.warning(f"You have a moderate risk level. Please check our home-level therapy for {issue_prediction_text}.")
    elif issue_prob >= 70:
        st.error(f"You have a High risk level. Please consult the Doctor and check our home-level therapy for {issue_prediction_text}.")
